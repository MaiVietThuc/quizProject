...
@section('teacher_content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent">
            ...
            <li class="breadcrumb-item"><a href="{{URL::to('/teacher/exam/history')}}">Lịch sử kiểm tra</a>
            </li>
                    ...
                    @foreach ($classExamResult as $cer)
                        <tr>                          
                            ...
                            <td class="text-center">
                                <a href="{{URL::to('teacher/exam/studentExamResultDetail/'.$cer->student_id.'&'.$examInfo->id)}}" class="action-icon text-primary mr-2" style="font-size: 25px;"><i class="far fa-eye"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
