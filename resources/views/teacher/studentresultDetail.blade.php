...
@section('teacher_content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent">
            ...
            <li class="breadcrumb-item"><a href="{{URL::to('/teacher/exam/')}}">Bài kiểm tra</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Kết quả bài kiểm tra {{$exam_info->title}}</li>
        </ol>
    </nav>
    <div class="container bg-white">
        ...
        @endif
            <h3 class=" m-2 text-primary mb-3">Kết quả kiểm tra <strong>{{$exam_info->title}}</strong></h3> 
            @if (Session('failed'))
        ...
        @if(!Session('error') && !Session('failed'))
            <div class="exam-result text-center">
                <h5 class="mb-1"><strong>{{$studentinf->name}}</strong></h5>
                ...
                <div class="col-lg-3  mt-4">
                    <div class="sticky-top pt-lg-4">
                        ...
                        <div class="wrap text-center mt-5">
                            ...
                            <a href="{{URL::to('teacher')}}"><button class="bg-primary text-light rounded">Về trang chủ</button></a>
                        </div>
                    </div>
                </div>
            </div>
