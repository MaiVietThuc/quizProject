                ...
                <div class="card-box shadow col-10  mr-5 pt-3 pb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-control"  style="height: 11rem;overflow-y: scroll;">
                            @foreach ($subjects as $subj)
                                @if($subj->id == $teacher->subject->id)                         
                                    <input type="checkbox" id="subject_{{$subj->id}}" name="subj[]" value="{{$subj->id}}" selected>
                    ...
                    <div class="form-group mb-3">
                        <div class="fallback">
                            ...
                            <img src="{{asset($teaher->avatar)}}" height="100" width="100" alt=""/>
