...
@section('admin_content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800 pl-3">Thêm giảng viên</h1>
    @if(count($errors) > 0)
    ...
    @endif
    <!-- mainform -->
    <form class="" action="{{URL::to('/admin/postAddTeacher')}}" method="post" autocomplete="off" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-6">
                <div class="card-box shadow col-10 ml-5  pt-3 pb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="Tên giảng viên">
                    </div>
                ...
                <div class="card-box shadow col-10  mr-5 pt-3 pb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-control"  style="height: 11rem;overflow-y: scroll;">
                            ...
                            <input type="checkbox" id="subject_{{$subj->id}}" name="subj[]" value="{{$subj->id}}">
                            <label class="mb-0 pb-2" style="width:90%" for="subject_{{$subj->id}}">{{$subj->subject_name}}</label><br>
                            @endforeach
                        </div>
                    </div>
